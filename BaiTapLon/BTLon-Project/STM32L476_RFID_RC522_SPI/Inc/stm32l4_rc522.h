...
#define MFRC522_CS_GPIO		GPIOD
#define MFRC522_CS_PIN		LL_GPIO_PIN_2
#define MFRC522_CS_RCC		LL_AHB2_GRP1_PERIPH_GPIOD

#define MFRC522_RST_GPIO	GPIOC
#define MFRC522_RST_PIN		LL_GPIO_PIN_2
#define MFRC522_RST_RCC		LL_AHB2_GRP1_PERIPH_GPIOC	

#define MFRC522_SPI							SPI3
#define MFRC522_SPI_GPIO				GPIOC					// 
#define MFRC522_SCK_PIN					LL_GPIO_PIN_10		// SCK
#define MFRC522_MISO_PIN				LL_GPIO_PIN_11		// MISO
#define MFRC522_MOSI_PIN				LL_GPIO_PIN_12		// MOSI
#define MFRC522_SPI_GPIO_RCC		LL_AHB2_GRP1_PERIPH_GPIOC
#define MFRC522_SPI_RCC					LL_APB1_GRP1_PERIPH_SPI3
