...
void Write_MFRC522(uchar addr, uchar val)
{
	...
	//SPI3_TransmitByte((addr<<1)&0x7E);
	//uint8_t dummy = SPI3_ReceiveByte();
	//SPI3_TransmitByte(val);
	//dummy = SPI3_ReceiveByte();
	while (!LL_SPI_IsActiveFlag_TXE(SPI3));
	LL_SPI_TransmitData8(SPI3, (addr<<1)&0x7E);
...
uchar Read_MFRC522(uchar addr)
{
	...
	//SPI3_TransmitByte(((addr<<1)&0x7E) | 0x80);
	//uint8_t dummy = SPI3_ReceiveByte();
	//SPI3_TransmitByte(0x00);
	//val = SPI3_ReceiveByte();
	while (!LL_SPI_IsActiveFlag_TXE(SPI3));
	LL_SPI_TransmitData8(SPI3, ((addr<<1)&0x7E) | 0x80);
	while (LL_SPI_IsActiveFlag_BSY(SPI3));
