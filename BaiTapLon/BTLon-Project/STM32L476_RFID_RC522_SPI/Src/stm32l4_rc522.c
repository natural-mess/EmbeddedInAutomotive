...
void Write_MFRC522(uint8_t addr, uint8_t val)
{
  ...
  //HAL_GPIO_WritePin(GPIOA,GPIO_PIN_9,GPIO_PIN_RESET);
	LL_GPIO_ResetOutputPin(MFRC522_CS_GPIO, MFRC522_CS_PIN);
	...
	LL_GPIO_SetOutputPin(MFRC522_CS_GPIO, MFRC522_CS_PIN);
}
...
void MFRC522_Init(void)
{
	...
	LL_GPIO_SetOutputPin(MFRC522_RST_GPIO, MFRC522_RST_PIN);
	LL_GPIO_SetOutputPin(MFRC522_CS_GPIO, MFRC522_CS_PIN);
